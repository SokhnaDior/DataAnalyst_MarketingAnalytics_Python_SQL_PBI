...
def fetch_data_from_sql():
   ...
   # )
    conn_str = (
        "Driver={ODBC Driver 18 for SQL Server};"  # Use ODBC Driver 17 or 18 for SQL Server
        "Server=localhost,1433;"  # Connect to localhost with port 1433
        "Database=PortfolioProject_MarketingAnalytics;"  # Your database name
        "UID=sa;"  # SQL Server default username
        "PWD=YourStrongPassword!;"  # Replace with your 'sa' password from Docker setup
